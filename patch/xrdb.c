void loadxrdb() {
  ...
  if (display != NULL) {
    ...
    if (resm != NULL) {
      ...
      if (xrdb != NULL) {
        XRDB_LOAD_COLOR("dwm.color4", normfgcolor); // normal fg
        ...
        XRDB_LOAD_COLOR("dwm.color0",
                        titleselfgcolor); // this is for the title bar
        ...
        XRDB_LOAD_COLOR("dwm.color0",
                        tagsselfgcolor); // this is for selected tag box
        ...
        XRDB_LOAD_COLOR("dwm.color4", urgfgcolor); // urgentfg
